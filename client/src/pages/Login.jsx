...
function App() {
    ...
    return (
        <div className="min-h-screen bg-black flex">
            <div
                className={`w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-12 xl:px-24 transition-all duration-500 ${
            ...
            <div
                className={`hidden lg:block w-1/2 bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-pink-500/10 relative overflow-hidden transition-all duration-500 ${
